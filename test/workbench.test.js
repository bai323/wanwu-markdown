...
describe('万物 Markdown 对话工作台', () => {
  ...
  it('提供对话资产包和打开窗口实时采集入口', async () => {
    ...
    assert.match(html, /启动万物专用浏览器资料夹/);
    ...
    assert.match(script, /打开超时，请关闭专用窗口后重试/);
